...
function(_package_load_boost_components)
  ...
  if(_boost_needed_components)
    ...
    foreach(_comp ${_boost_needed_components})
      if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.30)
        find_package(Boost COMPONENTS ${_comp})
      else()
        find_package(Boost COMPONENTS ${_comp} CONFIG)
      endif()
    ...
    endforeach()
  else() # Boost header only
    if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.30)
      set(Boost_VERBOSE TRUE)
      find_package(Boost REQUIRED)
      if (Boost_FOUND)
        if(TARGET Boost::headers)
          _package_add_libraries(${_pkg_name} Boost::headers)
        else()
          _package_add_include_dir(${_pkg_name} ${Boost_INCLUDE_DIRS})
        endif()
      endif()
    else()
...
function(_package_load_external_package pkg_name activate)
  ...
  if(NOT ${_real_name} MATCHES "Boost")
